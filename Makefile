...
OBJECTS = o_files/main.o o_files/createTree3.o o_files/createTree2.o o_files/copyNode.o o_files/newNode.o o_files/reduceTree.o o_files/calcDiff.o o_files/latexDump.o o_files/readFile.o o_files/createTree.o o_files/delTree.o o_files/wrDotFile.o o_files/wrPngFile.o
...
o_files/copyNode.o: source/mathTree/copyNode.cpp
	g++ -c source/mathTree/copyNode.cpp -o o_files/copyNode.o $(DEBUG_SET)  $(DIFFERENT_FLAGS) $(SANITIZER)
